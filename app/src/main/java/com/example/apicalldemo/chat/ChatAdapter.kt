...
class ChatAdapter(
    context: Context,
    private val mMessages: List<DataModelMessage>
) :
RecyclerView.Adapter<ChatAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        var layout = -1
        when (viewType) {
            DataModelMessage.TYPE_MESSAGE -> layout = R.layout.item_message
            DataModelMessage.TYPE_LOG -> layout = R.layout.item_log
            DataModelMessage.TYPE_ACTION -> layout = R.layout.item_action
        }

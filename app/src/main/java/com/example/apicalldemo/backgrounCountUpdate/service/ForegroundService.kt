...
import com.example.apicalldemo.roomDataBase.ListFragment
...
class ForegroundService() : Service() {
    ...
    override fun onCreate() {
        ...
        Log.e(javaClass.simpleName, "onCreate: count"+ SharedPrefs.getValue(
    ...
    override fun onTaskRemoved(rootIntent: Intent?) {
        ...
        Log.e(javaClass.simpleName, "onTaskRemoved count: "+ SharedPrefs.getValue(
            this@ForegroundService,
            "count",
            0
        )
